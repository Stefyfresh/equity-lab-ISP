        ...
        <div class="container px-5">
            ...
            <div class="columns">
                <div class="column is-two-fifths has-text-left">
                    <div class="block">&copy; Equity Lab 2023</div>
                    <p class="block">We are devoted to bringing equitable teaching resources to the classroom.</p>
                    <p> To learn how we use your personal data to train our Artificial Intelligence technology, read our <a
                            href="https://en.wikipedia.org/wiki/Privacy_policy" target="_blank">Privacy Policy.</a></p>
                </div>
